...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--train_dataset_size', default=5000, type=int,
                                 help="Will be used only if no latents are given")
        self.parser.add_argument('--test_dataset_size', default=1000, type=int,
                                 help="Will be used only if no latents are given")
        self.parser.add_argument('--work_in_stylespace', default=False, action='store_true',
                                 help="trains a mapper in S instead of W+")
        ...
        self.parser.add_argument('--stylegan_weights', default='pretrained_models/stylegan2-ffhq-config-f.pt', type=str,
        ...
        self.parser.add_argument('--checkpoint_path', default=None, type=str,
                                 help='Path to StyleCLIPModel model checkpoint')

        # self.parser.add_argument('--max_steps', default=50000, type=int, help='Maximum number of training steps')
        self.parser.add_argument('--max_steps', default=2, type=int, help='Maximum number of training steps')
